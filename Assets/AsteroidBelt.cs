...
public class AsteroidBelt : MonoBehaviour {
    ...
    public float speed;        //	Speed of the enemy's ships horizontal movement.
    ...
    void SpawnEnemies()
    {
        ...
        {
            GameObject enemy = Instantiate(enemyPrefab[Random.Range(0, enemyPrefab.Length)], child.transform.position, Quaternion.identity) as GameObject;
